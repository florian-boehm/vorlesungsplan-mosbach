...
package de.patricklammers.vorlesungsplan.app.actionbar;
...
public class ActionBarHelperBase extends ActionBarHelper
{
	...
	private void setupActionBar()
	{
		...
		{
			homeItem.setIcon(R.drawable.ic_home_with_arrow);
		}
		else
		{
	 ...
	 * {@link de.dhbw.mosbach.app.actionbar.example.android.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}.
	 */
	private View addActionItemCompatFromMenuItem(final MenuItem item)
	{
		...
		actionButton.setLayoutParams(new ViewGroup.LayoutParams((int) mActivity.getResources().getDimension(itemId == android.R.id.home ? R.dimen.actionbar_compat_button_home_width
		...
		{
			actionButton.setId(android.R.id.home);
		}
	...
	{				
		ImageButton ib = ((ImageButton) getActionBarCompat().findViewById(android.R.id.home));
		...
		if(value)
		{
			ib.setImageDrawable(mActivity.getApplicationContext().getResources().getDrawable(R.drawable.ic_home_with_arrow));			
		}
		else
		{
			ib.setImageDrawable(mActivity.getApplicationContext().getResources().getDrawable(R.drawable.ic_home));			
		}
		
		this.isDisplayHomeAsUpEnabled = value;
	}
